...
const createMigration = (opts: { key: any; version: any; migrate: any; }, data: unknown) => {
...
export const useStorage = (state: any, setState: { (payload: any): void; (arg0: unknown): void; }) => {
