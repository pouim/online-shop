...
export const PRICE_MENU_ITEM = {
  id: 'nav.price',
  defaultMessage: 'لیست قیمت',
  href: OFFER_PAGE,
};
export const BLOG_MENU_ITEM = {
  id: 'nav.blog',
  defaultMessage: 'بلاگ',
  href: 'http://185.206.147.122:8000/',
  target: '_blank',
};
export const FAQ_MENU_ITEM = {
  id: 'nav.faq',
  defaultMessage: 'سوالات متداول',
  href: OFFER_PAGE,
};
export const CONTACTUS_MENU_ITEM = {
  id: 'nav.contactus',
  defaultMessage: 'ارتباط با ما',
  href: CONTACTUS_PAGE,
};
